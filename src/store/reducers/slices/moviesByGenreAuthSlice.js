...
export const fetchMovie = createAsyncThunk('moviesByGenreAuthSlice/fetchMovie',
    async (_, { rejectWithValue }) => {
        try {
            const response = await axios.get(
                `${process.env.REACT_APP_VODIA_API_ENDPOINT}/frontend/home/authenticated?front=film`
            )
...
const moviesByGenreAuthSlice = createSlice({
    name: 'moviesByGenresAuth',
...
export default moviesByGenreAuthSlice.reducer
