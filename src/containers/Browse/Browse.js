...
import { Home, Movies, Tv, LatestVideo, List, HomeAuth, MoviesAuth, TvAuth } from './routes'
...
const Browse = props => {
    ...
    if (route === '/browse') {
        ...
        browseContent = <List />
    } else if (route === '/browse/home') {
        browseContent = <HomeAuth />
    } else if (route === '/browse/moviesAuth') {
        browseContent = <MoviesAuth />
    } else if (route === '/browse/tvAuth') {
        browseContent = <TvAuth />
    }
