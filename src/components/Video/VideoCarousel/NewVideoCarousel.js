...
const NewVideoCarousel = props => {
    ...
    const videoCards = carouselVideo.map(item => {
        ...
        return (
            item.backdrop_path && <div className={itemClass.join(' ')} key={item.id}
                ...
                <VideoCard
                    ...
                    trailer_path={item.video_trailer}
...
export default React.memo(NewVideoCarousel)